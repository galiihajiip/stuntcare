  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Selamat datang kembali di STUNTCARE",
      });
      ...
      if (profile?.role === "kader" || profile?.role === "admin_kader") {
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-4">
          ...
          <div className="text-center">
            <CardTitle className="text-2xl">Masuk ke STUNTCARE</CardTitle>
            <CardDescription>
